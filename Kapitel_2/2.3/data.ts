namespace KlappBuch {
    ...
    let chosenVariable: Plant = { //neue Variable, in der die Auswahl abgespeichert wird
        plant: "new",
        blossom: null,
        stem: null,
        vase: null
    ...
    function output(btn: HTMLButtonElement) {
        let id: string = btn.id;
        let numId: number = Number(id)-1;
    ...
    for(let i: number=0; i< x.length;i++){ //Für jeden "Box" Div wird ein Button erstellt
